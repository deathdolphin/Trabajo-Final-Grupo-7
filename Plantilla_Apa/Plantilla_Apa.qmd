...
Luego de hacer es proceso de depuración, se estudiaron a las variables "sex" y "age" para determinar que tanto abarcaban esta dos variables dentro de la base de datos, ordenándolas de forma ascendente para hacer mas fácil el manejo de dichas variables dentro de la base de datos.

Al momento de finalizar todo el proceso de filtrado, depuracion y ordenamiento de los registros, el siguiente paso fue realizar gráficos que facilitaran las interpretaciones de los datos y asi poder transmitir de forma clara todos los resultados obtenidos de la investigación.
